...
namespace ChillX.Serialization.Test.MessagePackEntity
{
    [MessagePackObject()]
    public class TestClassVariantA : IEqualityComparer<TestClassVariantA>
    {
        ...
        [MessagePack.Key(10)]
        public Half VariantAPropertyHalf { get; set; } = (Half)1.1f;
        ...
        public int GetHashCode([DisallowNull] TestClassVariantA obj)
        {
